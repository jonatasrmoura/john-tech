      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-lg text-zinc-400 sm:text-xl">
            Seu computador merece mais desempenho, segurança e vida útil.
            Transformamos máquinas lentas em equipamentos rápidos, silenciosos e
            prontos para qualquer desafio.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              href="#orcamento"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-cyan-400 px-6 py-3 font-semibold text-black transition hover:scale-[1.02] hover:bg-cyan-300"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-3 font-semibold text-white transition hover:scale-[1.02] hover:border-cyan-400/50 hover:bg-cyan-400/10"
            >
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-sm text-zinc-400">
            <div className="rounded-full border border-white/10 bg-white/5 px-3 py-2">
              Formatação Windows | Linux | MacOS
            </div>
            <div className="rounded-full border border-white/10 bg-white/5 px-3 py-2">
              Upgrade de peças
            </div>
            <div className="rounded-full border border-white/10 bg-white/5 px-3 py-2">
              Orçamento do seu novo PC Gamer com seu perfil
            </div>
            <div className="rounded-full border border-white/10 bg-white/5 px-3 py-2">
              Quebra de senha
            </div>
            ...
            <div className="rounded-full border border-white/10 bg-white/5 px-3 py-2">
              Reparo de sistema operacional corrompido
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <img
            src={heroVisual}
            alt="Ilustração tecnológica JohnTech"
            className="pointer-events-none absolute -right-6 -top-20 w-56 opacity-65 mix-blend-screen sm:w-72"
          />
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-4 shadow-[0_0_80px_rgba(0,191,255,0.16)] backdrop-blur-2xl">
            <div className="rounded-[1.5rem] border border-white/10 bg-[linear-gradient(135deg,_rgba(255,255,255,0.12),_rgba(255,255,255,0.03))] p-6">
              ...
              <div className="mt-6 rounded-2xl border border-cyan-400/20 bg-cyan-400/10 p-4 text-sm text-zinc-200">
                ...
                <p className="mt-2">
                  A cada visita, identificamos a causa raiz e entregamos uma
                  solução com foco em desempenho, segurança e durabilidade.
                </p>
              </div>
            </div>
          </div>
